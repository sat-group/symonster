 ...
 */
public class JarParserTest extends BodyTransformer {
    public static final String ANALYSIS_NAME = "jap.analysis";
    private static Map<String, List<String>> methodToAppearancesMap = new HashMap<>();
    ...
    public static void parseJar(List<String> libs, List<String> packg) {
        ...
        pckg = packg;
        G.reset();
        PackManager.v().getPack("jap").add(new Transform(ANALYSIS_NAME, new JarParserTest()));
    ...
    public static Map<String, List<String>> getMethodToAppearancesMap(){
    ...
    protected void internalTransform(Body body, String s, Map<String, String> map) {
        ...
        synchronized (this) {
            ...
            List<String> methodSet = new ArrayList<>();
